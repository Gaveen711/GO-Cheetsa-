    ...
    $.ajax({
        ...
        success: function(data) {
                ...
                for (let index = 0; index < dataArr.length; index++){
                    ...
                    "<td class='text-center'> <button type='button' name='delete' onclick='deleteUser("+dataArr2[0]+")'  class='btn btn-danger btn-sm ml-5'><i class='bi bi-trash text-white' ></i></button></td>";
                }
        }
    });
